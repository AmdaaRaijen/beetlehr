...
const deleteDataHandle = async () => {
    axios
        .delete(route("payroll.run.deleteslip", { id: itemSelected.value.id }))
        .then((res) => {
            notify(
                {
                    type: "success",
