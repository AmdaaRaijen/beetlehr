...
const getData = debounce(async (page) => {
    axios
        .get(route("attendance.shift.getdata"), {
            params: {
                page: page,
...
const deleteHandle = async () => {
    axios
        .delete(route("attendance.shift.delete", { id: itemSelected.value.id }))
        .then((res) => {
            notify(
                {
                    type: "success",
                    ...
                    <section>
                        ...
                        >
                            ...
                            >
                                ...
                                <td class="px-4 whitespace-nowrap h-16">
                                    <VBadge
                                        :text="data.shift_type"
                                        :color="getTypeStatus(data.shift_type)"
                                        size="sm"
                                    />
                                </td>
                                <td class="px-4 whitespace-nowrap h-16">
                                    {{ data.formated_start_time }}
                                </td>
                                <td class="px-4 whitespace-nowrap h-16">
                                    {{ data.formated_end_time }}
                                </td>
                                <td
